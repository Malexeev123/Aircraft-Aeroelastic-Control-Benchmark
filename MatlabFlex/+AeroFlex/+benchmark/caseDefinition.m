...
definition = struct( ...
    ...
    "initialFlightCondition",struct(), ...
    "terminalFlightCondition",struct(), ...
...
switch canonicalCaseId
    case "A1"
        definition.initialFlightCondition = localFlightCondition(40,1);
        definition.terminalFlightCondition = localFlightCondition(40,1);
        ...
        definition.executionAvailable = true;
    ...
    case "A3"
        ...
        definition.evidence = caseAEvidence;
    case "B1"
        definition.initialFlightCondition = localFlightCondition(15,10);
        definition.terminalFlightCondition = localFlightCondition(20,5);
        ...
        definition.commandEnabled = true;
        definition.qualificationStatus = ...
            "PRODUCTION_SCHEDULED_VALIDATION_PENDING";
        definition.executionAvailable = true;
...
function condition = localFlightCondition(speedMps,alphaDeg)
condition = struct("airspeedMps",speedMps, ...
