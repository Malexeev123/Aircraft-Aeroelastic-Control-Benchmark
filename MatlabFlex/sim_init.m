...
% Offset gust by the time ratio (only for control)
if p.Results.sim_case ~= "openloop"
    gust_start_tidx = floor(cfg.sim.t_end/ cfg.sim.dt); 
    cfg.gust.gust_offset =cfg.gust.gust_offset_ratio* gust_start_tidx;
